        ...
        System.out.println("8.  Exit");
          ...
          switch(choice){
            ...
            case 5:
              ...
              break;
            case 6:
              System.out.println("How do you want to sort the Directory?");
              System.out.println("1 for sort by Last name. 2 for sort by First name");
              int sortChoice = kb.nextInt();
              if (sortChoice == 1) {
                printDirectoryLast(listPerson);
              }
              else if (sortChoice == 2) {
                printDirectoryFirst(listPerson);
              }
              else{
                System.out.println("Only 1 and 2 accepted");
              }
              break;
            case 7:
              messaging();
...
//    }//End of while loop
  ...
  public static void sortByLastName(List<Person> list){
  ...
  public static void printDirectoryFirst(List<Person> list){
  ...
  public static void printDirectoryLast(List<Person> list){
    sortByLastName(list);
    for (int i=0; i<list.size(); i++) {
      System.out.println((list.get(i).toString()));
    }
  ...
  public static void messaging(){
    ...
    while (check!=-1) {
      ...
      QuickMessage qMsg = new QuickMessage();
      System.out.println("Enter 1 to send new message:" +
                         "\nEnter 2 to delete message:" +
                         "\nEnter 3 to print message(s):" +
                         "\nEnter 4 to exit");
